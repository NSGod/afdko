...
class dimensionHinter(ABC):
    ...
    def __init__(self, options) -> None:
        ...
        self.report: GlyphReport | None = None
        self.name = ""
        self.isMulti = False
        self.hs: glyphHintState = glyphHintState()
        self.fddict: FDDict | None = None
        self.Bonus: int = 0
        self.Pruning = False
    ...
    def nodeIsFlat(self, c, doPrev=False) -> bool | None:
        """
    ...
    def sameDir(self, c, doPrev=False) -> bool | None:
        """
    ...
    def genSegs(self) -> None:
        ...
        if self.handleOverlap():
            ...
            self.glyph = removeOverlap(origGlyph)  # type: ignore[assignment]
    ...
    def stemMiss(self, ls, us) -> int | None:
        """
    ...
    def limitVals(self) -> None:
        ...
        kept_locations = set((sv.lloc, sv.uloc) for weight, sv
                             in ol[:self.StemLimit])
