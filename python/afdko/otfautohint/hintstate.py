...
class hintSegment:
    ...
    # pe: weakref.ReferenceType[pathElement | None]
    pe: Callable[[], pathElement] | None

    def __init__(self, aloc: float, oMin: float, oMax: float,
                 pe: pathElement | None, typ, bonus, isV,
                 isInc, desc: str) -> None:
        """
        ...
        if pe:
            ...
            self.pe = None
        self.hintval: stemValue | None = None
        self.replacedBy: Self | None = None
        self.deleted = False
...
class glyphHintState:
    ...
    def __init__(self) -> None:
        ...
        self.ghostCompat: list[list[bool] | None] = []
...
class links:
    ...
    def shuffle(self) -> list[int] | None:
        """
